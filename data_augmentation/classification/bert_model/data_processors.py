...
class TSVDataProcessor(DatasetProcessor):
    ...
    def __init__(self, args, skip_header, label_col, text_col):
        ...
        self.train_path = base_path + f'data_augmentation/augmentation_num_{args.aug_num:02}/exp_{args.exp_id:02}/{args.augmenter}/' + \
                         f"train_subsample_{seednum:03}_{args.augmenter}.jsonl"
        self.dev_path = base_path + f'data_subsample/exp_{args.exp_id:02}/' + \
                        f"dev_subsample_{seednum:03}.jsonl"
